...
# Mini App web server. Binds to all interfaces by default so it works both
# behind a reverse proxy (VPS: nginx/Caddy terminating TLS) and on PaaS
# platforms (Railway/Render) that inject their own PORT and forward public
# HTTPS traffic to it directly. Telegram requires Mini App URLs to be HTTPS.
